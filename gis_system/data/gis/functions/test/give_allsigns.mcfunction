...
give @p minecraft:oak_sign{display: {Name: '{"text":"ホテル入口へ"}'},BlockEntityTag: {Color:"green",GlowingText:1b,Text1:'{"text":"","clickEvent":{"action":"run_command","value":"/function gis:system/sign_click/sound_sign_click"}}',Text2:'{"color":"green","clickEvent":{"action":"run_command","value":"/execute in minecraft:overworld run tp @s 155.0 14 59.0 90 0"},"text":"ホテル入口へ"}',Text3:'{"text":""}',Text4:'{"color":"green","text":"≪右クリック≫"}'}}
