...
execute as @s[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",tag:{ID:159}}},level=..0] run playsound minecraft:block.dispenser.fail player @a ~ ~ ~ 1 1
...
execute as @s[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",tag:{ID:141}}},level=..2] at @s run playsound minecraft:block.dispenser.fail player @a ~ ~ ~ 1 1
