...
item modify entity @s armor.head gis:item/prot_d1
item modify entity @s armor.chest gis:item/prot_d2
item modify entity @s armor.legs gis:item/prot_d3
item modify entity @s armor.feet gis:item/prot_d4
item modify entity @s armor.head gis:item/prot_d1
item modify entity @s armor.chest gis:item/prot_d2
item modify entity @s armor.legs gis:item/prot_d3
item modify entity @s armor.feet gis:item/prot_d4
