...
execute if score #nether_boss gis_event_flag matches 6 as 0000006e-0000-0000-0000-000200000000 at @s[tag=!gis_nb_h] if score @s instant matches ..512 run function gis:system/entity_system/entity_skill/boss/boss_n/boss_n_skill_s
