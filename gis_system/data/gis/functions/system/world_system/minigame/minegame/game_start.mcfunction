...
give @s[scores={gis_mine_skill=0}] minecraft:diamond_pickaxe{CanDestroy:["minecraft:stone","minecraft:coal_ore","minecraft:diamond_ore","minecraft:gold_ore","minecraft:iron_ore","minecraft:lapis_ore","minecraft:redstone_ore"],Unbreakable:1b,Enchantments:[{id:"minecraft:efficiency",lvl:5s},{id:"minecraft:fortune",lvl:2s}]} 1
