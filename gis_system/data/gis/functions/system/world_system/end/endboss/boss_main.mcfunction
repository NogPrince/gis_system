...
execute if score #end_boss gis_event_flag matches 3 as 0000006e-0000-0000-0000-000300000000 at @s[tag=!gis_eb_h] if score @s gis_instant1 matches ..512 run positioned 0 78 0 rotated 0 0 run summon item_display ~ ~ ~ {UUID:[I;110,0,3,101],Rotation:[0F,-90F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0f,0f,0f]},item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:1012}}}
execute if score #end_boss gis_event_flag matches 3 as 0000006e-0000-0000-0000-000300000000 at @s[tag=!gis_eb_h] if score @s gis_instant1 matches ..512 run positioned 0 78 0 rotated 0 0 run data merge entity 0000006e-0000-0000-0000-000300000065 {start_interpolation:-1,interpolation_duration:60,Rotation:[0F,-90F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[30f,30f,1f]}}
