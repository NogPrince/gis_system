...
execute if score #end_boss gis_event_flag matches 2 if score #end_boss_summon gis_timer1 matches 1..100 in minecraft:end_boss positioned 0 63 0 rotated 0 0 run function gis:system/entity_system/entity_skill/boss/boss_e/sub/particle_1
