...
execute if score #end_boss gis_event_flag matches 2 if score #end_boss_summon gis_timer1 matches 1 in minecraft:end_boss positioned 0 63 0 rotated 0 0 run summon item_display ~ ~ ~ {UUID:[I;110,0,3,101],start_interpolation:-1,interpolation_duration:20,Rotation:[0F,-90F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0f,0f,0f]},item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:1012}}}
execute if score #end_boss gis_event_flag matches 2 if score #end_boss_summon gis_timer1 matches 2 in minecraft:end_boss run data merge entity 0000006e-0000-0000-0000-000300000065 {start_interpolation:-1,interpolation_duration:60,Rotation:[0F,-90F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[20f,20f,1f]}}
...
execute if score #end_boss gis_event_flag matches 2 if score #end_boss_summon gis_timer1 matches 90 in minecraft:end_boss run data merge entity 0000006e-0000-0000-0000-000300000065 {start_interpolation:-1,interpolation_duration:10,Rotation:[0F,-90F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[20f,20f,0f]}}
