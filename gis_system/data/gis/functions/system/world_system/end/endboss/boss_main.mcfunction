...
execute if score #end_boss gis_event_flag matches 2 if score #end_boss_summon gis_timer1 matches 30 in minecraft:end_boss run data merge entity 0000006e-0000-0000-0000-000300000065 {start_interpolation:-1,interpolation_duration:60,Rotation:[0F,-90F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[30f,30f,1f]}}
...
execute if score #end_boss gis_event_flag matches 2 if score #end_boss_summon gis_timer1 matches 2..100 in minecraft:end_boss run execute as 0000006e-0000-0000-0000-000300000065 at @s run tp @s ~ ~ ~ ~2 ~
...
execute if score #end_boss gis_event_flag matches 2 if score #end_boss_summon gis_timer1 matches 100 in minecraft:end_boss positioned 0 64 0 rotated 0 0 run summon minecraft:husk ~ ~ ~ {UUID:[I;110,0,3,0],PortalCooldown:60,DeathLootTable:"no",PersistenceRequired:1b,CanPickUpLoot:0b,Health:1024f,IsBaby:0b,CanBreakDoors:1b,ActiveEffects:[{Id:14,Amplifier:1b,Duration:-1,ShowParticles:0b},{Id:11,Amplifier:3b,Duration:-1,ShowParticles:0b}],Tags:["gis_mob","gis_par_black","gis_par_parple","gis_part","gis_ridedown","gis_void_resist","gis_m_skill"],Passengers:[{id:"minecraft:area_effect_cloud",UUID:[I;110,0,3,1],CustomNameVisible:1b,Radius:0f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:100000000,Tags:["gis_mob","gis_rideup","gis_void_resist","gis_m_skill"],CustomName:'{"text":"帝国の怨霊","color":"dark_red","bold":true}'}],CustomName:'{"text":"帝国の怨霊"}',ArmorItems:[{id:'minecraft:leather_boots',Count:1b,tag:{display:{color:2826337}}},{id:'minecraft:leather_leggings',Count:1b,tag:{display:{color:2826337}}},{id:'minecraft:leather_chestplate',Count:1b,tag:{display:{color:2826337}}},{id:'minecraft:crying_obsidian',Count:1b}],ArmorDropChances:[-327.670F,-327.670F,-327.670F,-327.670F],Attributes:[{Name:generic.max_health,Base:1024},{Name:generic.follow_range,Base:50},{Name:generic.knockback_resistance,Base:1},{Name:generic.attack_damage,Base:20},{Name:generic.armor,Base:30},{Name:zombie.spawn_reinforcements,Base:0}]}
...
execute if score #end_boss gis_event_flag matches 3 as 0000006e-0000-0000-0000-000300000000 at @s[tag=!gis_eb_h] if score @s gis_instant1 matches ..512 positioned 0 78 0 rotated 0 0 run summon item_display ~ ~ ~ {UUID:[I;110,0,3,101],Rotation:[0F,-90F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],CustomName:'{"text":"帝国型魔導レーザー"}',translation:[0f,0f,0f],scale:[0f,0f,0f]},item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:1020}}}
execute if score #end_boss gis_event_flag matches 3 as 0000006e-0000-0000-0000-000300000000 at @s[tag=!gis_eb_h] if score @s gis_instant1 matches ..512 positioned 0 78 0 rotated 0 0 run data merge entity 0000006e-0000-0000-0000-000300000065 {start_interpolation:-1,interpolation_duration:60,Rotation:[0F,-90F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[30f,30f,1f]}}
