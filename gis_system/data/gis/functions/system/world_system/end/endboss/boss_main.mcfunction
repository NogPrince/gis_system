...
execute if score #end_boss gis_event_flag matches 2 if score #end_boss_summon gis_timer1 matches 50 in minecraft:end_boss run data merge entity 0000006e-0000-0000-0000-000300000065 {start_interpolation:-1,interpolation_duration:50,Rotation:[0F,-90F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,-2f],scale:[30f,30f,0f]}}
