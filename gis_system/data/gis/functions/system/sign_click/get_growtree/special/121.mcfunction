execute as @s[advancements={gis:gameplay/growtree_ability_special/_12=false}] store success score @s gis_instant1 run tellraw @s {"text":"グロウツリーの前提要素が解放されていません"}
...
execute as @s[advancements={gis:gameplay/growtree_ability_special/121=true}] unless score @s gis_instant1 matches 1.. store success score @s gis_instant1 run tellraw @s {"text":"この要素はすでに解放されています"}
...
execute as @s unless score @s gis_instant1 matches 1.. if score @s gis_tp matches 64.. run tellraw @s [{"text":"[明察秋毫]","color":"green"},{"text":"を開放しました","color":"white","bold":false}]
execute as @s unless score @s gis_instant1 matches 1.. if score @s gis_tp matches 64.. run advancement grant @s only gis:gameplay/growtree_ability_special/121
