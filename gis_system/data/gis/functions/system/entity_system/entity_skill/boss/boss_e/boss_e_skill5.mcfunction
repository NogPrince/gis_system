...
execute in minecraft:end_boss as 0000006e-0000-0000-0000-000300000002 at @s positioned 0 76 0 run summon item_display ~ ~1 ~ {PortalCooldown:120,UUID:[I;110,0,3,2],Rotation:[0F,-90F],Tags:["gis_boss_e_5_display","gis_mob","gis_kill"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0f,0f,1f]},item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:1010}}}
