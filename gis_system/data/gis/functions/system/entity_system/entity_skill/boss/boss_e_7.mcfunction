...
execute as @s[tag=gis_boss_e_7_magic] at @s positioned ~ ~ ~ as @a[distance=..3] at @s run damage @s 50 minecraft:lightning_bolt by 0000006e-0000-0000-0000-000300000007
