...
execute as @s at @s positioned ~ ~ ~ as @a[distance=..1] at @s run damage @s 120 minecraft:lightning_bolt by 0000006e-0000-0000-0000-000300000007
tag @s[nbt={PortalCooldown:10}] add gis_boss_e_51_beam
execute as @s[tag=gis_boss_e_7_magic] at @s positioned ~ ~ ~ as @a[distance=..3] at @s run damage @s 120 minecraft:lightning_bolt by 0000006e-0000-0000-0000-000300000007
