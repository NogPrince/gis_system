...
execute as 0000006e-0000-0000-0000-000200000008 at @s run fill ^15 ^ ^-2.5 ^-15 ^ ^-2.5 minecraft:redstone_block
execute as 0000006e-0000-0000-0000-000200000008 at @s run fill ^15 ^ ^-4.5 ^-15 ^ ^-4.5 minecraft:air
