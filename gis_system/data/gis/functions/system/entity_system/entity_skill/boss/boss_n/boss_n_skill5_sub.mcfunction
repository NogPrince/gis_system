...
execute as 0000006e-0000-0000-0000-000200000006 at @s run particle minecraft:lava ~ 22 ~-18 8 0 1.5 2 3 normal
execute as @a at @s if predicate gis:system/position_check/in_boss_n if block ~ 42 ~ minecraft:redstone_block run damage @s 80 minecraft:mob_attack by 0000006e-0000-0000-0000-000200000001
