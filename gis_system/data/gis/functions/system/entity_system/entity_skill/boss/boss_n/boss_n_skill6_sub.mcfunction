...
execute as 0000006e-0000-0000-0000-000200000008 at @s run fill ^16.4 ^ ^ ^-16.4 ^ ^ minecraft:redstone_block
execute as 0000006e-0000-0000-0000-000200000008 at @s run fill ^16.4 ^ ^-5 ^-16.4 ^ ^-5 minecraft:air
