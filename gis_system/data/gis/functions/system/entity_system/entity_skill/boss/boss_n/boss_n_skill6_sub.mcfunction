...
execute as @a at @s if predicate gis:system/position_check/in_boss_n if block ~ 43 ~ minecraft:redstone_block run damage @s 80 minecraft:mob_attack by 0000006e-0000-0000-0000-000200000001
