...
execute as 0000006e-0000-0000-0000-000200000000 at @s run summon minecraft:spawner_minecart 170.0 37.00 -1.0 {NoGravity:1b,PortalCooldown:200,UUID:[I;110,0,2,7],SpawnCount:3,SpawnRange:17,Delay:10,MinSpawnDelay:10,MaxSpawnDelay:11,MaxNearbyEntities:90,RequiredPlayerRange:40,Tags:["gis_mob","gis_kill"],SpawnData:{entity:{id:"minecraft:magma_cube",PortalCooldown:25,Health:1000f,Size:0,wasOnGround:1b,Tags:["gis_mob","gis_kill","gis_ridedown","gis_boss_n_4"],Passengers:[{id:"minecraft:item_display",Rotation:[0F,-90F],Tags:["gis_mob","gis_rideup"],transformation:{left_rotation:[0.3826f,0f,0f,0.9238f],right_rotation:[0f,0f,0.3826f,0.9238f],translation:[0f,0f,-0.5f],scale:[1.5f,1.5f,1.5f]},item:{id:"minecraft:magma_block",Count:1b}}],Attributes:[{Name:generic.max_health,Base:1000},{Name:generic.knockback_resistance,Base:1},{Name:generic.attack_damage,Base:60}]}}}
...
execute as 0000006e-0000-0000-0000-000200000000 at @s[tag=gis_nb_h] run data modify entity 0000006e-0000-0000-0000-000200000001 PortalCooldown set value 300
