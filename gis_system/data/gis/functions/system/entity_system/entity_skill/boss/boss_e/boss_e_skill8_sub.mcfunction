...
execute in minecraft:end_boss as 0000006e-0000-0000-0000-000800000008 at @s[nbt={PortalCooldown:60}] run data merge entity @s {start_interpolation:-1,interpolation_duration:5,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,30f],scale:[0.7f,0.7f,60f]},item:{id:"minecraft:sea_lantern",Count:1b}}
