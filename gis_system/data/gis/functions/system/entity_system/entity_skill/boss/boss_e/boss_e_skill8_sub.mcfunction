...
execute in minecraft:end_boss as 0000006e-0000-0000-0000-000800000008 at @s[nbt={PortalCooldown:179}] run data merge entity @s {start_interpolation:-1,interpolation_duration:20,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,20f],scale:[0.3f,0.3f,60f]}}
execute in minecraft:end_boss as 0000006e-0000-0000-0000-000800000008 at @s[nbt={PortalCooldown:100}] run data merge entity @s {start_interpolation:-1,interpolation_duration:20,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,20f],scale:[0.5f,0.5f,60f]}}
execute in minecraft:end_boss as 0000006e-0000-0000-0000-000800000008 at @s[nbt={PortalCooldown:80}] run data merge entity @s {start_interpolation:-1,interpolation_duration:20,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,20f],scale:[0.1f,0.1f,60f]}}
execute in minecraft:end_boss as 0000006e-0000-0000-0000-000800000008 at @s[nbt={PortalCooldown:61}] run data merge entity @s {start_interpolation:-1,interpolation_duration:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,20f],scale:[0.01f,0.01f,60f]},item:{id:"minecraft:sea_lantern",Count:1b}}
execute in minecraft:end_boss as 0000006e-0000-0000-0000-000800000008 at @s[nbt={PortalCooldown:60}] run data merge entity @s {start_interpolation:-1,interpolation_duration:20,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,20f],scale:[0.6f,0.6f,60f]},item:{id:"minecraft:sea_lantern",Count:1b}}
