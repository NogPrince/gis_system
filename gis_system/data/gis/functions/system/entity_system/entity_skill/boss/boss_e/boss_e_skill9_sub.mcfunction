...
execute in minecraft:end_boss as 0000006e-0000-0000-0000-000300000009 at @s[nbt={PortalCooldown:200}] run data merge entity @s {start_interpolation:-1,interpolation_duration:100,Rotation:[0F,-90F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],item:{id:"minecraft:white_stained_glass",Count:1b,tag:{CustomModelData:1005}},translation:[0f,0f,-1f],scale:[0.8f,0.8f,80f]}}
