...
execute in minecraft:end_boss as 0000006e-0000-0000-0000-000900000009 at @s[nbt={PortalCooldown:200}] as 0000006e-0000-0000-0000-000900000009 run data merge entity @s {start_interpolation:-1,interpolation_duration:10,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,-1f],scale:[0.2f,0.2f,80f]},item:{id:"minecraft:sea_lantern",Count:1b,tag:{CustomModelData:1005}}}
