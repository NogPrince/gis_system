...
execute as 0000006e-0000-0000-0000-000a00000001 at @s run data merge entity @s {start_interpolation:-1,interpolation_duration:10,Rotation:[0F,-90F],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,-1f],scale:[2f,2f,2f]}}
