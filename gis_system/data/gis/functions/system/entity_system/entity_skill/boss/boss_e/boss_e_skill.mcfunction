...
execute as 0000006e-0000-0000-0000-000300000000 at @s run summon item_display ~ ~ ~ {UUID:[I;110,0,10,2],PortalCooldown:45,glow_color_override:1b,Tags:["gis_mob","gis_kill"],brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-0.2f,0f],scale:[2f,3f,2f]},item:{id:"minecraft:light_gray_stained_glass",Count:1b,tag:{Enchantments:[{}]}}}
