...
execute as 0000006e-0000-0000-0000-000300000000 at @s run summon item_display ~ ~ ~ {UUID:[I;110,0,10,1],PortalCooldown:65,Rotation:[90F,0F],Tags:["gis_mob","gis_kill"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,-1f],scale:[0f,0f,0f]},item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:1010}}}
