...
execute as 0000006e-0000-0000-0000-000300000000 at @s run summon item_display ~ ~ ~ {UUID:[I;110,0,10,2],PortalCooldown:65,glow_color_override:1b,Tags:["gis_mob","gis_kill"],brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-0.2f,0f],scale:[2f,3f,2f]},item:{id:"minecraft:purple_stained_glass",Count:1b,tag:{CustomModelData:1,Enchantments:[{}]}}}
execute as 0000006e-0000-0000-0000-000300000000 at @s run summon interaction ~ ~ ~ {UUID:[I;110,0,10,3],PortalCooldown:60,width:0.65f,height:2f,Tags:["gis_mob","gis_kill","end_boss_shell"]}
...
schedule function gis:system/entity_system/entity_skill/boss/boss_e/boss_e_skill_resistance_sub 60t append
schedule function gis:system/entity_system/entity_skill/boss/boss_e/boss_e_skill_shell_sub0 1t append
