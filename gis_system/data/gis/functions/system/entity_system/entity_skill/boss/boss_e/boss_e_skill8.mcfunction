...
execute in minecraft:end_boss at 0000006e-0000-0000-0000-000300000000 positioned ~ ~1 ~ run summon armor_stand ~ ~ ~ {UUID:[I;110,0,4,8],Marker:1b,Invisible:1b,Tags:["gis_mob","gis_kill","gis_boss_e_8"],PortalCooldown:180}
execute in minecraft:end_boss at 0000006e-0000-0000-0000-000300000000 positioned ~ ~1 ~ run summon item_display ~ ~ ~ {UUID:[I;110,0,8,8],Tags:["gis_mob","gis_no_turn","gis_kill"],PortalCooldown:180,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,20f],scale:[0f,0f,40f]},item:{id:"minecraft:light_gray_stained_glass",Count:1b,tag:{CustomModelData:1005}}}
