execute in minecraft:end_boss at 0000006e-0000-0000-0000-000300000000 positioned ~ ~1 ~ run summon armor_stand ~ ~ ~ {UUID:[I;110,0,3,8],Marker:1b,Invisible:1b,Tags:["gis_mob","gis_kill","gis_boss_e_8",gis_ridedown],PortalCooldown:180,Passengers:[{id:"minecraft:item_display",Tags:["gis_mob","gis_rideup"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[30f,30f,1f]},item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:1005}}}]}
