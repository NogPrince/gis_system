execute in minecraft:end_boss positioned 0 63 0 rotated 0 0 run summon minecraft:armor_stand ~ ~ ~ {PortalCooldown:280,UUID:[I;110,0,3,9],Marker:1b,Invisible:1b,Tags:["gis_mob","gis_kill","gis_boss_e_9","gis_ridedown"],Passengers:[{id:"minecraft:item_display",Rotation:[0F,-90F],Tags:["gis_mob","gis_rideup"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1f]},item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:1002}}}]}
