...
execute in minecraft:end_boss positioned 0 63 0 rotated 0 0 run summon armor_stand ~ ~ ~ {UUID:[I;110,0,4,9],Marker:1b,Invisible:1b,Tags:["gis_mob","gis_kill","gis_boss_e_9"],PortalCooldown:120,Passengers:[{id:"minecraft:item_display",Tags:["gis_mob","gis_kill"],PortalCooldown:280,UUID:[I;110,0,9,9],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.1f,0.1f,80f]},item:{id:"minecraft:light_gray_stained_glass",Count:1b,tag:{CustomModelData:1005}}}]}
