execute in minecraft:end_boss positioned 0 63 0 rotated 0 0 run summon minecraft:armor_stand ~ ~ ~ {PortalCooldown:280,UUID:[I;110,0,3,9],Marker:1b,Invisible:1b,Tags:["gis_mob","gis_kill","gis_boss_e_9"],Passengers:[{id:"minecraft:item_display",Rotation:[0F,-90F],Tags:["gis_boss_e_9_display","gis_mob","gis_kill"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.5f,1.5f,1f]},item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:1002}}}]}

execute in minecraft:end_boss as 0000006e-0000-0000-0000-000300000007 at @s positioned 0 69 0 run summon item_display ~ ~ ~ {}
