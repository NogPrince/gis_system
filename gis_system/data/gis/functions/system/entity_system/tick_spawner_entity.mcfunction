...
#スポナー破壊数
execute if entity @s[type=minecraft:armor_stand] unless entity @s[tag=gis_dummy] run scoreboard players add #spawner gis_stats 1
execute if score #spawner gis_stats matches 1.. unless score #spawner gis_event_flag matches 1.. run advancement grant @a only gis:gameplay/_main/adv26
